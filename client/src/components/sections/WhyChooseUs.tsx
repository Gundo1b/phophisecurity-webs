const WhyChooseUs = () => {
  ...
  const handleFeatureClick = (featureName: string) => {
    console.log(`Clicked on ${featureName} - navigating to contact`);
    ...
    <section id="why-us" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 - Experienced Tutors */}
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Experienced Tutors")}
          >
          ...
          {/* Feature 2 - Easy-to-Understand Methods */}
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Easy-to-Understand Methods")}
          >
          ...
          {/* Feature 3 - Concept Clarity */}
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Concept Clarity")}
          >
          ...
          {/* Feature 4 - Small Batch Sizes */}
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Small Batch Sizes")}
          >
            <div className="flex items-center justify-center w-12 h-12 bg-blue-100 rounded-full mb-4">
          ...
          {/* Feature 5 - Affordable Fees */}
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Affordable Fees")}
          >
            <div className="flex items-center justify-center w-12 h-12 bg-green-100 rounded-full mb-4">
          ...
          <div 
            className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow cursor-pointer hover:scale-105 transform transition-all duration-200"
            onClick={() => handleFeatureClick("Proven Results")}
          >
            <div className="flex items-center justify-center w-12 h-12 bg-violet-100 rounded-full mb-4">
